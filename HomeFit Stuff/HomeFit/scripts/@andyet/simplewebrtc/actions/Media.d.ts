...
import { ADD_MEDIA, MEDIA_UPDATED, REMOVE_MEDIA } from '../Constants';
...
export declare type Actions = AddMedia | RemoveMedia | MediaUpdated;
/**
 ...
 */
export declare function addRemoteMedia(roomAddress: string, peerAddress: string, track: MediaStreamTrack, stream: MediaStream, screen: boolean): ThunkAction<void, State, void, AddMedia | RemoveMedia>;
/**
 * @description
 * Remove media.
 *
